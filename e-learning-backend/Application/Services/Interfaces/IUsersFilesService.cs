...
{
    Task<List<GetFileDTO>> GetUserFilesAsync(Guid userId, CancellationToken ct = default);
    ...
    Task<List<GetFileDTO.TagDTO>> GetUserFileTags(Guid userId, CancellationToken ct = default);
